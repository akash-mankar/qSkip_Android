...
public class LocatorActivity extends FragmentActivity implements
    ...
    // StoresActivity the current instantiation of the location client in this object
    ...
    private ConnectionCallbacks mConnectionCallbacks = new ConnectionCallbacks() {
        ...
        public void onConnected(Bundle arg0) {
            ...
            locationRequest.setInterval(0).setPriority(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
    ...
    public void getLocation() {
        ...
        try {
		        ...
		        String locStr = null;
		        locStr = Location.convert(currentLocation.getLatitude(), FORMAT_DEGREES);
		        locStr += " ";
		        locStr += Location.convert(currentLocation.getLongitude(), FORMAT_DEGREES);
		        // Display the current location in the UI
		        //mLatLng.setText(LocationUtils.getLatLng(this, currentLocation));
		        Intent retData = new Intent();
		        retData.putExtra("location", locStr);
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new LocatorActivity.GetAddressTask(this)).execute(currentLocation);
        }
    }
